var listaNumeros = [2,4,6,-1,5,-4,0];
/**
 * Recibe
...
function encontrarPalabraMasCorta(listaDePalabras) {
    ...
    for(let i=0; i < listaDePalabras; i++)
    {
 ...
 * SEPARARLOS POR COMA, ESPACIOS Y PUNTO FINAL (ultimo elemento por separado)
 * Retorna: 
